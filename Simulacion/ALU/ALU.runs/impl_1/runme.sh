...
HD_PWD='C:/Users/royer.sanabria/Desktop/ROYER/FPGA/Proyecto/Codigos/Simulacion/ALU/ALU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MULTIPLEXOR_VIO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MULTIPLEXOR_VIO.tcl -notrace
