...
HD_PWD='C:/Users/royer.sanabria/Desktop/ROYER/FPGA/Proyecto/Codigos/Simulacion/ALU/ALU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MULTIPLEXOR_VIO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MULTIPLEXOR_VIO.tcl
